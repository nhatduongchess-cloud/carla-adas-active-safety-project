...
def worker(args, journal):
    ...
    from scripts.tools.smoke_carla_camera import spawn_test_vehicle
    from scripts.dataset.collect_carla_dataset import spawn_heavy_vehicles, spawn_two_wheelers, spawn_walkers
