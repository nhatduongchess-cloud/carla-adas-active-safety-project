...
#
# Dung:  powershell -ExecutionPolicy Bypass -File .\run_until_crash.ps1 [-SpawnIndex 2] [-Town Town10HD_Opt]
...
if (-not (Test-Server)) {
    ...
    Start-Process -FilePath (Join-Path $PSScriptRoot 'launch_carla.bat') -WorkingDirectory $PSScriptRoot
